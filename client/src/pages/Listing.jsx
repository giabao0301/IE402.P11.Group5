          ...
          <div className="flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4">
            ...
            <ul className="text-green-900 font-semibold text-sm flex flex-wrap items-center gap-4 sm:gap-6 my-2">
              ...
              <li className="flex items-center gap-1 whitespace-nowrap ">
                ...
                {listing.parking ? "Có bãi đỗ xe" : "Không có bãi đỗ xe"}
              </li>
              <li className="flex items-center gap-1 whitespace-nowrap ">
            ...
            <div className="text-slate-800">
              <span className="font-semibold text-black">Thông tin mô tả:</span>
              <div
